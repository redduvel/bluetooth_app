...
class _TemplatePageState extends State<TemplatePage> {
  ...
  List<Template> templates = [
    Template(listProducts: List.empty(), title: "Пустой шаблон")
  ];
                        ...
                        selectDataController: SelectDataController(data: [
                          const SingleCategoryModel(singleItemCategoryList: [
                            SingleItemCategoryModel(
                                nameSingleItem: 'Продукт 1',
                                value: 'Product 1'),
                            SingleItemCategoryModel(
                                nameSingleItem: 'Продукт 2',
                                value: 'Product 2'),
                            SingleItemCategoryModel(
                                nameSingleItem: 'Продукт 3',
                                value: 'Product 3'),
                            SingleItemCategoryModel(
                                nameSingleItem: 'Продукт 4',
                                value: 'Product 4'),
                            SingleItemCategoryModel(
                                nameSingleItem: 'Продукт 5',
                                value: 'Product 5'),
                            SingleItemCategoryModel(
                                nameSingleItem: 'Продукт 6',
                                value: 'Product 6'),
                            SingleItemCategoryModel(
                                nameSingleItem: 'Продукт 7',
                                value: 'Product 7'),
                          ])
                        ])),
                  )
